                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <h4 class="info-title">Teknik Destek</h4>
                            <p>Erc İşitme Merkezi tüm marka ve model işitme cihazlarının teknik servis ve bakımını, kendi özel servisinde,en kısa sürede ve uygun fiyatlarla yapmaktadır.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info">
                            ...
                            <h4 class="info-title">İŞİTME TESTİ</h4>
                            <p>İşitme merkezlerimizde uzman işitme danışmanlarımız tarafından işitme testi yaparak size özel cihazı seçiyoruz.Sizde işitme testi yaptırmak isterseniz işitme merkezimize davetlisiniz.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Adınız</label>
                                    <input type="email" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="bmd-label-floating">Email Adresiniz</label>
                                    <input type="email" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="exampleMessage" class="bmd-label-floating">Mesajınız</label>
