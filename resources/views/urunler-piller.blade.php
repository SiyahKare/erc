...
<div class="main main-raised">
    <div class="section">
        <div class="container">
            <h2 class="section-title">Ürünler - Piller</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card card-blog">
                        <div class="card-header card-header-image">
                            <a href="">
                                <img src="/assets/image/products/piller/siemens10.png" alt="Siemens 10">
                            </a>
                        </div>
                        <div class="card-body">
                            <h3 class="card-category text-rose">Siemens 10</h3>
                            <h5 class="card-title">
                                <a href="#"></a>
                            </h5>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card card-blog">
                        <div class="card-header card-header-image">
                            <a href="#">
                                <img src="/assets/image/products/piller/siemens13.png" alt="Siemens 13">
                            </a>
                        </div>
                        <div class="card-body">
                            <h3 class="card-category text-rose">Siemens 13</h3>
                            <h5 class="card-title">
                                <a href="#"></a>
                            </h5>
                        </div>
                    ...
                    <div class="card card-blog">
                        <div class="card-header card-header-image">
                            <a href="/urunler-purecharge">
                                <img src="/assets/image/products/piller/siemens312.png" alt="Siemens 312">
                            </a>
                        </div>
                        <div class="card-body ">
                            <h3 class="card-category text-rose">Siemens 312</h3>
                            <h5 class="card-title">
                                <a href="#"></a>
                            </h5>
                        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card card-blog">
                        <div class="card-header card-header-image">
                            <a href="">
                                <img src="/assets/image/products/piller/siemens675.png" alt="Siemens 675">
                            </a>
                        </div>
                        <div class="card-body">
                            <h3 class="card-category text-rose">Siemens 675</h3>
                            <h5 class="card-title">
                                <a href=""></a>
                            </h5>
                        </div>
