                ...
                <div class="col-md-6 col-sm-6">
                    <div class="tab-content">
                        <div class="tab-pane active" id="product-page1">
                            <img src="/assets/image/products/signia/3purecharge.png" />
                        </div>
                    </div>

                </div>
                <div class="col-md-6 col-sm-6">
                    <h2 class="title"> Pure Charge&Go X </h2>
                    <h3 class="main-price">Dünyanın İlk Akıllı Haraket Sensörlü İşitme Cihazı</h3>
                    <div id="accordion" role="tablist">
                        ...
                        <div class="card card-collapse">
                            ...
                            <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                                <div class="card-body">
                                    <ul>
                                        <li>Yeni Sarj Ünitesi ile Kolay Sarj ve Tam Bağlantı </li>
